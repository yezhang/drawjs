...
| YAML | 标题 | 当前状态 | 备注 |
|------|------|----------|------|
| M1 | 几何与 Graphics 基础 | `in_progress` | AD-020/021 已收口 Graphics state stack 边界；AD-022 已补 Dimension / PointList / precision geometry；AD-023 已补 text/image/alpha 命令层语义 |
