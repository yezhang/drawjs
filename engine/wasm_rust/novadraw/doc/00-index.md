...
│   ├── ifigure_interface.md      # d2 IFigure 接口分析
│   ├── figure_implementation.md  # d2 Figure 实现分析
│   └── figure_box_model.md       # 盒模型分析
│
├── 03-rendering/                 # 渲染管线
│   ├── rendering_pipeline.md     # 渲染管线开发清单
...
2. trampoline_rendering.md   # 理解遍历机制
3. graphics_api.md           # 熟悉绘图 API
4. displaylist_detailed.md   # 深入实现细节
```
