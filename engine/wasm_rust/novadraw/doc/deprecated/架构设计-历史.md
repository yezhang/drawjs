...
> ⚠️ **历史文档** — 本文档为早期架构设计记录，内容已被《理想架构设计.md》取代。
>
> **关键冲突点**：
> - 交互状态归属：本文档将 mouse_target/focus_owner/captured 放在 EventDispatcher；《理想架构设计.md》已改为统一收敛到 FigureGraph
> - EventDispatcher 与 FigureGraph 的持有关系：《理想架构设计.md》要求 EventDispatcher 通过 DispatchContext 访问 Graph，不直接持有引用
> - UpdateManager 层级：本文档未明确上移；《理想架构设计.md》确定在 NovadrawSystem 层级
>
> **仍有参考价值的部分**：Figure API 映射表（Section 5）、Phase 里程碑、Connection/Layer 早期草案。请对照《理想架构设计.md》确认后再使用。
...
- [doc/03-rendering/update_manager_pipeline.md](../03-rendering/update_manager_pipeline.md) - g2 UpdateManager 完整分析
- [doc/03-rendering/rendering_pipeline.md](../03-rendering/rendering_pipeline.md) - 渲染管线开发清单
- [doc/02-figure/figure_core_concepts.md](../02-figure/figure_core_concepts.md) - Figure 核心概念
- [doc/01-architecture/gef_principle.md](../01-architecture/gef_principle.md) - GEF 框架原理
