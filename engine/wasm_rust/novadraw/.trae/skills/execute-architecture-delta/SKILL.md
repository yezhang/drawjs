...
description: "Executes one minimal architecture delta with root-cause-first analysis. Invoke when a current delta is selected and you want to make bounded progress safely."
---
